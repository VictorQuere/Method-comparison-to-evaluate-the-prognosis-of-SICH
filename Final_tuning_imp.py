...
#Import des données
df_train = pd.read_csv('train_imp.csv',sep=';',header=0, na_values = 'nan')
df_test =pd.read_csv('test_imp.csv',sep=';',header=0, na_values = 'nan')
...
# Print ROC curve
plt.plot(fpr,tpr,label="Imputed data, auc= 0.81")
plt.title( 'ROC curve Random Forest on imputed Data')
